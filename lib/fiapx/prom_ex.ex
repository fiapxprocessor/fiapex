defmodule Fiapx.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule FiapxWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :fiapx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: FiapxWeb.Router, endpoint: FiapxWeb.Endpoint},
      Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:fiapx, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
